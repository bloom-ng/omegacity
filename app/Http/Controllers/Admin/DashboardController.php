...
class DashboardController extends Controller
{
    public function index()
    {
        ...
        $pieChartData = [
            ...
            'Land Listings' => $stats['land_listings']['count'],
            'Invoices' => $stats['invoices']['count'],
            'Receipts' => $stats['receipts']['count'],
        ];

        // Histogram: monthly counts
        $monthlyChartData = [
            'Contacts' => $stats['contacts']['monthly'],
            'Clients' => $stats['clients']['monthly'],
            'Land Listings' => $stats['land_listings']['monthly'],
            'Invoices' => $stats['invoices']['monthly'],
            'Receipts' => $stats['receipts']['monthly'],
        ];
