...
<body class="bg-[#F3F3F3] text-[#010504]">
    ...
    <div class="max-w-5xl mx-auto bg-white shadow-md p-8 rounded-lg mt-8">
        ...
        <form method="POST" action="{{ route("eoi.store") }}" enctype="multipart/form-data" class="space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                <input name="title" placeholder="Title (Mr/Mrs/Dr)"
                ...
                <input name="first_name" placeholder="First Name"
                    class="w-full border-2 border-gray-700 p-3 rounded-md bg-white focus:ring-2 focus:ring-black focus:border-black outline-none">
                <input name="other_names" placeholder="Other Names"
                    class="w-full border-2 border-gray-700 p-3 rounded-md bg-white focus:ring-2 focus:ring-black focus:border-black outline-none">
                <input name="nationality" placeholder="Nationality"
                    class="w-full border-2 border-gray-700 p-3 rounded-md bg-white focus:ring-2 focus:ring-black focus:border-black outline-none">
                <input name="state_of_origin" placeholder="State of Origin"
                    class="w-full border-2 border-gray-700 p-3 rounded-md bg-white focus:ring-2 focus:ring-black focus:border-black outline-none">
           ...
           focus:ring-black focus:border-black outline-none">
                ...
                <div id="id_upload_wrapper" class="hidden mt-2">
                    <label class="block font-semibold">Attach ID Document</label>
            ...
            <textarea name="residential_address" placeholder="Residential Address"
            ...
            <textarea name="business_address" placeholder="Business/Office Address"
                class="w-full border-2 border-gray-700 p-3 rounded-md bg-white focus:ring-2 focus:ring-black focus:border-black outline-none"></textarea>
            ...
            <input name="nok_name" placeholder="Next of Kin Name"
                class="w-full border-2 border-gray-700 p-3 rounded-md bg-white focus:ring-2 focus:ring-black focus:border-black outline-none">
            <input name="nok_mobile" placeholder="Next of Kin Mobile"
                class="w-full border-2 border-gray-700 p-3 rounded-md bg-white focus:ring-2 focus:ring-black focus:border-black outline-none">
            <textarea name="nok_address" placeholder="Next of Kin Address"
                class="w-full border-2 border-gray-700 p-3 rounded-md bg-white focus:ring-2 focus:ring-black focus:border-black outline-none"></textarea>
            <input name="nok_email" placeholder="Next of Kin Email"
                class="w-full border-2 border-gray-700 p-3 rounded-md bg-white focus:ring-2 focus:ring-black focus:border-black outline-none">
            <select id="nok_id_type" name="nok_id_type"
                class="w-full border-2 border-gray-700 p-3 rounded-md bg-white focus:ring-2
           focus:ring-black focus:border-black outline-none">
                <option value="">Next of Kin Means of Identification</option>
                <option value="Driver License">Driver License</option>
                <option value="National ID Card">National ID Card</option>
                <option value="International Passport">International Passport</option>
                <option value="Voter’s Card">Voter’s Card</option>
            ...
            <!-- NOK ID Upload -->
            <div id="nok_id_upload_wrapper" class="hidden mt-2">
                <label class="block font-semibold">Attach Next of Kin ID Document</label>
                <input type="file" name="nok_id_file"
                    class="w-full border-2 border-gray-700 p-3 rounded-md bg-white
                  focus:ring-2 focus:ring-black focus:border-black outline-none">
            </div>
            ...
            <input name="agent_name" placeholder="Agent Name (Optional)"
                class="w-full border-2 border-gray-700 p-3 rounded-md bg-white focus:ring-2 focus:ring-black focus:border-black outline-none">
            <input name="agent_phone" placeholder="Agent Phone (Optional)"
                class="w-full border-2 border-gray-700 p-3 rounded-md bg-white focus:ring-2 focus:ring-black focus:border-black outline-none">
            ...
            <input name="applicant_name" placeholder="Applicant Name"
                class="w-full border-2 border-gray-700 p-3 rounded-md bg-white focus:ring-2 focus:ring-black focus:border-black outline-none">
    ...
    <script>
        ...
        // NOK ID
        document.getElementById('nok_id_type').addEventListener('change', function() {
            let wrapper = document.getElementById('nok_id_upload_wrapper');
            wrapper.classList.toggle('hidden', this.value === '');
        });
    </script>
