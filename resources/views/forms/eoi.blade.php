    ...
    <div class="max-w-5xl mx-auto bg-white shadow-md p-8 rounded-lg mt-8">
        ...
        <form method="POST" action="{{ route("eoi.store") }}" enctype="multipart/form-data" class="space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                <input name="title" placeholder="Title (Mr/Mrs/Dr)" class="input">
                <input name="surname" placeholder="Surname" class="input">
                <input name="first_name" placeholder="First Name" class="input">
                <input name="other_names" placeholder="Other Names" class="input">
                <input name="nationality" placeholder="Nationality" class="input">
                <input name="state_of_origin" placeholder="State of Origin" class="input">
                <input name="lga" placeholder="LGA" class="input">
                ...
                <input name="marital_status" placeholder="Marital Status" class="input">
                <input name="mobile" placeholder="Mobile No" class="input">
                <input name="email" placeholder="Email" type="email" class="input">
                <input name="id_type" placeholder="Valid Means of Identification" class="input">
            </div>

            <textarea name="residential_address" placeholder="Residential Address" class="input"></textarea>
            <textarea name="business_address" placeholder="Business/Office Address" class="input"></textarea>

            <!-- Applicant Passport -->
            <label class="block font-semibold">Applicant Passport Photo</label>
            <input type="file" name="passport_photo" class="input">

            <!-- SECTION B -->
            <h3 class="font-bold text-lg border-b mb-2 mt-6">SECTION B – NEXT OF KIN</h3>

            <input name="nok_name" placeholder="Next of Kin Name" class="input">
            <input name="nok_mobile" placeholder="Next of Kin Mobile" class="input">
            <textarea name="nok_address" placeholder="Next of Kin Address" class="input"></textarea>
            <input name="nok_email" placeholder="Next of Kin Email" class="input">
            <input name="nok_id_type" placeholder="Next of Kin Valid Means of Identification" class="input">

            <!-- SECTION C -->
            <h3 class="font-bold text-lg border-b mb-2 mt-6">SECTION C – CATEGORY OF LAND</h3>

            <select name="land_category" class="input">
            ...
            <select name="payment_option" class="input">
                <option value="">Payment Option</option>
                <option>Full Payment</option>
                <option>Installment</option>
            </select>

            <input name="agent_name" placeholder="Agent Name (Optional)" class="input">
            <input name="agent_phone" placeholder="Agent Phone (Optional)" class="input">
            ...
            <input name="applicant_name" placeholder="Applicant Name" class="input">
            ...
            <input type="date" name="signature_date" class="input">

             <label class="block font-semibold ">Additional Info</label>
            <textarea name="additional_info" placeholder="Additional Info" class="input"></textarea>
