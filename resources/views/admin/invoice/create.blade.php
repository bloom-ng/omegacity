                ...
                <div id="invoice-items" class="space-y-4">
                    ...
                    <div class="grid grid-cols-12 gap-4 items-end">
                        ...
                        <div class="col-span-2">
                            ...
                            <input type="number" name="items[0][tax]" min="0" max="100" value="0"
                                step="0.01"
                                class="w-full border border-gray-300 rounded-md px-3 py-2 focus:outline-none focus:ring-2 focus:ring-black focus:border-transparent">
                        </div>
    ...
    @push("scripts")
        ...
        `;
            ...
            function calculateTotals() {
                ...
                document.querySelectorAll('#invoice-items > div').forEach((item, index) => {
                    const quantity = parseFloat(item.querySelector('input[name*="[quantity]"]').value) || 0;
                    const price = parseFloat(item.querySelector('input[name*="[price]"]').value) || 0;
                    const taxRate = parseFloat(item.querySelector('input[name*="[tax]"]').value) || 0;
