...
@section("content")
    <div class="w-full">
        <div class="flex justify-between items-center mb-6">
            <h1 class="text-2xl font-bold text-gray-800">Create Updated Receipt</h1>
        </div>

        <form action="{{ route("admin.update-receipts.store") }}" method="POST" class="bg-white rounded-lg shadow-md p-6">
            @csrf
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        <label for="commission_percentage" class="block text-sm font-medium text-gray-700 mb-1">Commission
                            (%)</label>
                        <input type="number" name="commission_percentage" id="commission_percentage" value="0" min="0"
                            step="0.01"
                            class="w-full border border-gray-300 rounded-md px-3 py-2 focus:outline-none focus:ring-2 focus:ring-black">
                    </div>
